...
class ReplayBuffer(object):
    ...
    def __init__(self, random_seed=123):
        ...
        self.max_size = 1000000 # you can change this 
        self.count = 0
        self.state_dim = #add based your project
        self.action_dim = #add based your project 
    ...
    def add(self, state, action, reward, done, next_state):
        ...
        # Data is stored in the buffer, and it will keep adding if it is less than 1e6
        ...
        # The number of data exceeds the buffer size, first-in-first-out
        else:
    ...
    def sample_batch(self, batch_size = 16, max_hisLen = 10):
        ...
        for i, id in enumerate(idxs):                                             # i: index, id: value
            
            his_startID = id - max_hisLen

            # Among these 10 historical steps, if one is done, then count from the next one of this done.
            ...
            his_seg_len = id - his_startID   # The trimmed length of history
